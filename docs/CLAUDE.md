...
1. **No mocks in the settlement path.** Real testnet FXRP and USDT0 (both from the Coston2 faucet), the real FTSOv2 XRP/USD feed, and a real attested TEE signer. "It works on the demo" must mean it works against Coston2, not against a stub.
